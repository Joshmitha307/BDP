...
object SQLdf {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("/Users/josmithatammareddy/IdeaProjects/untitled2/survey.csv")


    //df.show()

    df.write.format("csv").option("header","true").save("/Users/josmithatammareddy/IdeaProjects/untitled2/output1")
    //df.write.csv("/Users/josmithatammareddy/IdeaProjects/untitled2/survey_savefile.csv")
    ...
    val lines = sc.textFile("/Users/josmithatammareddy/IdeaProjects/untitled2/survey.csv")
