...
object t2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df1 = spark.read
      ...
      .load("/Users/josmithatammareddy/IdeaProjects/lab2/WorldCups.csv")

    val df2 = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/josmithatammareddy/IdeaProjects/lab2/WorldCupPlayers.csv")

    val df3 = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/josmithatammareddy/IdeaProjects/lab2/WorldCupMatches.csv")
    ...
    val csv = sc.textFile("/Users/josmithatammareddy/IdeaProjects/lab2/WorldCups.csv")
